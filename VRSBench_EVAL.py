...
with open("/home/user01/PythonProject/CPM-9G-8B/FM9G4B-V/eval/VRSBench/VRSBench_EVAL_Cap.json", "r") as f:
    dataset = json.load(f)

image_dir_path = "/home/user01/PythonProject/CPM-9G-8B/FM9G4B-V/DataSet/VRSBench/Images/Images_val/"
...
for item in tqdm(dataset, desc="Running Inference"):  # ✅ tqdm 包裹迭代器
    ...
    image_file_path = f"{image_dir_path}{image_id}"
    references = item["ground_truth"]
...
# 保存结果
output_path = "/home/user01/PythonProject/CPM-9G-8B/FM9G4B-V/eval/VRSBench/results_cap.json"
